...
export const PLAIN_REPLY_SCENARIOS: readonly EvalScenario[] = [
  {
    ...
    description:
      "«покажи останні 3 замовлення» lists a page; reply is not a JSON spoken envelope. Markdown tables keep speech.source model.",
    fixture: "proof",
    host: "live",
  ...
  },
  {
    ...
    description:
      "«скільки замовлень цього тижня» uses orders_list_counts; reply is not a JSON spoken envelope. Markdown tables keep speech.source model.",
    fixture: "proof",
    host: "live",
