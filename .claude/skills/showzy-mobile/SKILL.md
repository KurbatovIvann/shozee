...
| Task | Skill path |
| --- | --- |
| Vague Expo/mobile request | `.claude/skills/expo-overview/SKILL.md` |
| Routes, groups, Stack, redirects, headers | `.claude/skills/expo-router/SKILL.md` |
| Keyboard, safe area, HIG, native controls, screen chrome | `.claude/skills/expo-native-ui/SKILL.md` |
| Unistyles tokens, `src/theme/`, `src/components/ui/` | `.claude/skills/expo-design-system/SKILL.md` |
| Reanimated, gestures, press feedback, haptics, sheets | `.claude/skills/expo-animation/SKILL.md` |
| Custom dev client, native rebuilds | `.claude/skills/expo-dev-client/SKILL.md` |
| `Text`/`Pressable`/lists/FlashList/scroll | `.claude/skills/vercel-react-native-skills/SKILL.md` then the matching `rules/*.md` |
